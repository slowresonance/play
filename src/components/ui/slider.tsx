...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-[#343434] dark:bg-[#343434]">
      <SliderPrimitive.Range className="absolute h-full bg-[#454545] dark:bg-slate-50" />
